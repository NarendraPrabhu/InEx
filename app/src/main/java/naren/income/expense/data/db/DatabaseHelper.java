package naren.income.expense.data.db;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public Cursor query(int day, int month, int year){
        ...
        return getReadableDatabase().query(InEx.class.getSimpleName(), null, queryString, null, null, null, InEx.COLUMN_DATE+" ASC", null);
    }
